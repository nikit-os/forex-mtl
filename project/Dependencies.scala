...
object Dependencies {
  ...
  object Libraries {
    ...
    lazy val sttpCatsClient      = sttp("async-http-client-backend-cats-ce2")
    ...
    lazy val scalacacheCats      = scalacache("scalacache-cats-effect")
    lazy val scalacacheCirce      = scalacache("scalacache-circe")
